...
import { useSubmitCreateSalesSummary } from "./useSubmitCreateSalesSummary";
...
describe("useSubmitCreateSalesSummary", () => {
  beforeEach(() => {
    pushMock.mockClear();
  ...
  it("登録成功後に一覧へ遷移する", async () => {
    const { result } = renderHook(() => useSubmitCreateSalesSummary());
